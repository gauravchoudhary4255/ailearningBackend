export = Object.freeze({
  ...
  COMMON: {
    ...
    ACTIVATE_SUCCESS: ':attribute has been activate successfully.',
    DEACTIVATE_SUCCESS: ':attribute has been deactivate successfully.',
  ...
  DAILY_WHEEL_BONUS: {
    DAYS_AVAILABLE: 'Daily wheel bonus days are available.',
    ALL_DAYS_EXISTS: 'Daily wheel bonus for all days are already exists.'
  },
