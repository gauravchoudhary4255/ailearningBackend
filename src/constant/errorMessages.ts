export = Object.freeze({
  ...
  COMMON: {
    ...
    IMAGE_DIMENSTIONS: 'The dimension of :attribute must be :format.',
    ...
    ALREADY_REGISTER: 'This :attribute already registered successfully',
    SAME_VALUE: 'The :attribute1 and :attribute2 must be same.',
    ONE_ALLOWED: 'Sorry, More than one :attribute not allowed.'
  },
  ...
  BLOCKED_USER: 'You are deactivated please contact Administrator to Activate Account.',
  ...
  NEXT_WITHDRAWAL_AVAILABLE_MESSAGE : 'The next transaction will be available in :attribute Hours',

  NEXT_TRANS_TWENTY_FOUR_HOURS : 'Crossed the Max transction limit in 24 Hours',
  ...
  ZOOP_ONE_ERROR_ARRAY: [
    'api key is invalid or disabled',
    'app not found',
    'action disallowed for the product',
    'ip not whitelisted',
    'product not subscribed by app',
    'org not found',
    ...
    'Source Down',
    'Internal Error',
    'You are not Authorized to make this request as your wallet balance is low',
    'Wallet balance reaching zero and there are too many pending requests',
    'Unknown Error'
  ]
